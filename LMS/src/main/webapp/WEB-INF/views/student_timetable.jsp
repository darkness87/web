...
function drawEmptyTable(){
	var header="<ul id='thead'><li class='time'>시간/요일</li><li class='mon'>월</li><li class='tue'>화</li><li class='wed'>수</li><li class='thu'>목</li><li class='fri'>금</li></ul>"
	...
	for(var i = 1;i<=7;i++){ //세로 교시
		...
		for(var j=0;j<6;j++){ //가로 요일
			if(j==0){
				row+=("<li class='"+arClassName[j]+"' id='td"+j.toString()+i+"'>"+i+"교시 <br>"+arTime[i-1]+"</li>");
			} else{
